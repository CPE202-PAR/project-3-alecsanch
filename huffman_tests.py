...
class TestHuffman(unittest.TestCase):
    ...
    def test_combine(self) -> None:
        ...
        # Test for the case when both arguments are None
        with self.assertRaises(ValueError):
            combine(None, None)

        # Test for the case when a is None
        c = combine(None, b)
        ...
        # Test for the case when b is None
        c = combine(a, None)
        ...
        # Test for the case when both a and b are not None
        c = combine(a, b)
